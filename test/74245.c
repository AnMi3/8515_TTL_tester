...
#define P_VCC	BIT_H0
	...
	Port_H = P_VCC;
	Port_E = 0;
	res &= ( (Pin_L == (P_DIR | P_A1 | P_A3 | P_A5 | P_A7)) && (Pin_H == (P_B5 | P_B3 | P_B1 | P_VCC)) && (Pin_E == P_B7) );

	Port_L = P_DIR | P_A2 | P_A4 | P_A6;
	Port_H = P_VCC;
	Port_E = P_A8;
	res &= ( (Pin_L == (P_DIR | P_A2 | P_A4 | P_A6)) && (Pin_H == (P_B6 | P_B4 | P_B2 | P_VCC)) && (Pin_E == (P_A8 | P_B8)) );
	...
	Port_E = P_B8;
	delay1ms();
	res &= ( (Pin_L == (P_A2 | P_A4 | P_A6)) && (Pin_H == (P_B6 | P_B4 | P_B2 | P_VCC)) && (Pin_E == (P_B8 | P_A8)) );
